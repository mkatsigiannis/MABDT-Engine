"""Quick MQTT broker reachability check, used by run_sweep.bat.
...
doesn't. Standalone — no dependencies on `mabdt` or `bench`.

Usage:
    python bench/check_broker.py
    python bench/check_broker.py --host your-broker-host --port 1883
"""
