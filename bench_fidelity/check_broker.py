"""Quick MQTT broker reachability check, used by run_fidelity.bat.
...
Usage:
    python bench_fidelity/check_broker.py
    python bench_fidelity/check_broker.py --host your-broker-host --port 1883
"""
